...
const events = ["spontaneously combusted", "melted into a puddle in the sidewalk", "Turned into a slug and slithered away"];
...
function generateStory() {
  ...
  newStory = newStory.replace("94 Fahrenheit", tempurature);
  }
